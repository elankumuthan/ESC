    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          <p className="ft-list-title">Do Business With Us</p>
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@ascenda.com">support@ascenda.com</a>
            </li>
            <li>
              <a href="mailto:appointment@ascenda.com">
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/company/ascenda-loyalty/"
              title="LinkedIn"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.facebook.com/goascenda/"
              title="FaceBook"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="https://x.com/acenda_official?lang=en"
              title="Twitter"
              target="_blank"
              rel="noopener noreferrer"
            >
